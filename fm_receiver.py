...
# Title: FM Radio Receiver (Simulation)
...
class fm_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "FM Radio Receiver (Simulation)", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FM Radio Receiver (Simulation)")
        ...
        self.audio_decim = audio_decim = int(samp_rate / audio_rate)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(audio_rate, analog.GR_SIN_WAVE, 1000, 0.5, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_audio_decim(int(self.samp_rate / self.audio_rate))
